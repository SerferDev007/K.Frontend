  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex fixed top-5 inset-x-0 mx-auto max-w-fit z-[5000] px-6 py-2 items-center bExpenses bExpenses-transparent dark:bExpenses-white/[0.2] rounded-full dark:bg-black bg-white shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] space-x-4",
          className
        )}
      >
        {/* Nav items */}
